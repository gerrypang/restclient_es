...
public class ProductController {
    ...
    @ResponseBody
    public List<HitEntity<MjbProduct>> search(@RequestParam(value="query") String query) {
    	String deCodeQuery = "";
		try {
    	...
    	List<HitEntity<MjbProduct>> returnList = productRepository.findPageByOneParam(deCodeQuery);
    ...
    @ResponseBody
    public Page<HitEntity<MjbProduct>> searchPage(
    		@RequestParam(value = "query", required = false) String query,
			@RequestParam(value = "page", required = false, defaultValue = "0") int page,
			@RequestParam(value = "pageSize", required = false, defaultValue = "10") int pageSize) {
    	String deCodeQuery = "";
    	Page<HitEntity<MjbProduct>> returnPage = null;
